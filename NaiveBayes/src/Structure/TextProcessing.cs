...
public static class TextProcessing
{
    ...
    public static string[] RemoveIsolatedNums(string[] tokens)
    {
        return tokens.Where(token => !isIsolatedNumber(token)).ToArray();
    }

    private static bool isIsolatedNumber(string token)
    {
